...
function getActionIcon($action) {
    switch (strtolower($action)) {
        ...
        case 'update': return 'bx-edit-alt';
        case 'delete': return 'bx-trash';
        case 'password_change': return 'bx-lock-alt';
...
function getActionColor($action) {
    switch (strtolower($action)) {
        ...
        case 'logout': return '#7f8c8d';
        case 'create': return '#3498db';
        case 'update': return '#f39c12';
        case 'delete': return '#e74c3c';
        case 'password_change': return '#9b59b6';
